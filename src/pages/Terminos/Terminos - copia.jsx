...
export default function Terminos() {
  ...
  // 2) Mantiene visible el item activo dentro del índice (sin pelear con el scroll manual)
  useEffect(() => {
  ...
  const handleIndexClick = (e) => {
    ...
    const panel = navRef.current || a.closest(".terminos__nav");
    if (!panel) return;
      ...
      <div className="terminos__container">
        ...
        <article className="terminos__content">
          ...
          <section id="modificaciones-terminos" className="terminos__section">
            ...
            <p>Nuvem podrá actualizar estos Términos y Condiciones en cualquier momento.</p>
            <p>Las modificaciones aplicarán únicamente a proyectos nuevos o vigentes previo aviso.</p>
          </section>
