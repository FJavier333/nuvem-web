      ...
      <div className="politica__container">
        ...
        <article className="politica__content">
          ...
          <section id="enfoque" className="politica__section">
            <div className="politica__sectionReveal" data-reveal>
          ...
          >
            <div className="politica__sectionReveal" data-reveal data-reveal-delay="1">
          ...
          <section
            ...
            className="politica__section"
          >
            <div className="politica__sectionReveal" data-reveal data-reveal-delay="2">
          ...
          <section
            ...
            className="politica__section"
          >
            <div className="politica__sectionReveal" data-reveal data-reveal-delay="3">
          ...
          <section
            ...
            className="politica__section"
          >
            <div className="politica__sectionReveal" data-reveal data-reveal-delay="4">
